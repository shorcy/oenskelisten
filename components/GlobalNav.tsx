...
const features = [
  {
    name: 'Inviter',
    description: 'Inviter familie og venner til din ønskeliste.',
    href: '#',
    icon: UserGroupIcon,
  },
  {
    name: 'Ekstra information',
    description: 'Angiv relevant information i forhold til størrelse, farve, mål og med mere.',
    href: '#',
    icon: InformationCircleIcon,
  },
  {
    name: 'Forslag',
    description: "Vi kan komme med forslag til ønsker.",
    href: '#',
    icon: GiftIcon,
  },
  {
    name: 'Gratis',
    description: "Det koster dig ikke noget at bruge ønskelisten.",
    href: '#',
    icon: BanknotesIcon,
  },
];
